...
def upload_video(request):
    ...
    try:
        ...
        response_data = {
            ...
            "strengths_improvements": text_analysis.get("strengths_improvements", {}),
            "emotion_analysis": text_analysis.get("emotion_analysis", {}),
            "confidence_analysis": text_analysis.get("confidence_analysis", {})
        }
        
        # Debug: Print emotion_analysis data being sent to frontend
        print("Django API emotion_analysis data:", text_analysis.get("emotion_analysis", {}))
