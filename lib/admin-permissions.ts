  ...
  try {
    ...
    if (!isAdmin) {
      return {
        ...
        isAdmin: false,
        corporateAccountId: decoded.account_id || decoded.corporateAccountId || null,
    ...
    if (requiredAccountId && (decoded.account_id || decoded.corporateAccountId) !== requiredAccountId) {
      return {
        isAuthenticated: true,
        isAdmin: true,
        corporateAccountId: decoded.account_id || decoded.corporateAccountId || null,
